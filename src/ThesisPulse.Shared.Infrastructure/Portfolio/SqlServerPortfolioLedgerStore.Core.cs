...
public sealed partial class SqlServerPortfolioLedgerStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            await ApplyLotsAsync(
                ...
                accounting,
                cancellationToken);
            await ApplyCashAsync(connection, transaction, fill, cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var positions = await ReadPositionSnapshotsAsync(connection, portfolio, cancellationToken);
        var cash = await ReadCashSnapshotsAsync(connection, portfolio, cancellationToken);
