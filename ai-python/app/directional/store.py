...
class DirectionalIntelligenceStore(Protocol):
    provider_name: str
...
class InMemoryDirectionalIntelligenceStore:
    provider_name = "InMemory"

    def __init__(self) -> None:
        self._sync = RLock()
        self._processed_sources: dict[str, StoredDirectionalOutput | None] = {}
        self._outputs: dict[
            tuple[str, str, datetime],
            list[StoredDirectionalOutput],
        ] = {}
    ...
    def process(
        ...
        with self._sync:
            ...
            stored = StoredDirectionalOutput(
