...
IF OBJECT_ID(N'[intelligence].[engines]', N'U') IS NULL
    THROW 61901, 'V0004 intelligence.engines is required.', 1;

DECLARE @actor nvarchar(256) = N'ThesisPulse.Seed.S0009';
DECLARE @seed_time datetime2(7) = '2026-06-30T00:00:00';
DECLARE @engine_uid uniqueidentifier = '38f3a9d4-6e57-5e85-93b7-1f55eab129e9';
DECLARE @engine_code varchar(100) = 'THESIS_PULSE_TECHNICAL_DIRECTION';
...
BEGIN
    ...
    (
        @engine_uid,
        @engine_code,
        N'ThesisPulse Deterministic Technical Direction Engine',
        'DIRECTIONAL_VOTER',
        'ThesisPulse.AI',
        0,
        0,
...
(
    ...
    THROW 61902, 'Technical directional engine seed drift detected.', 1;
