...
IF OBJECT_ID(N'[intelligence].[engines]', N'U') IS NULL
    THROW 61801, 'V0004 intelligence.engines is required.', 1;

DECLARE @actor nvarchar(256) = N'ThesisPulse.Seed.S0008';
DECLARE @seed_time datetime2(7) = '2026-06-30T00:00:00';
DECLARE @engine_uid uniqueidentifier = 'f4c975be-fdad-5ad0-a4bd-a2f2571a6941';
DECLARE @engine_code varchar(100) = 'THESIS_PULSE_FEATURE_FACTORY';
...
BEGIN
    ...
    (
        @engine_uid,
        @engine_code,
        N'ThesisPulse Point-in-Time Feature Factory',
        'CONTEXT_PROVIDER',
        'ThesisPulse.AI',
        0,
        0,
...
(
    ...
    THROW 61802, 'Feature Factory engine seed drift detected.', 1;
