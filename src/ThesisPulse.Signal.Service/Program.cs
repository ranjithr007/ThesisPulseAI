    ...
    OptionChainRuntimeOptions optionChainRuntime) => Results.Ok(new
{
    ...
    optionChainWorkerDiscoveryEnabled = optionChainRuntime.WorkerDiscoveryEnabled,
    optionChainWorkerPollIntervalSeconds = optionChainRuntime.WorkerPollIntervalSeconds,
    optionChainWorkerBatchSize = optionChainRuntime.WorkerBatchSize,
    optionChainWorkerSnapshotMaximumAgeSeconds = optionChainRuntime.WorkerSnapshotMaximumAgeSeconds,
    optionChainWorkerExecutionEnabled = optionChainRuntime.WorkerExecutionEnabled,
    optionChainWorkerExecutionPollIntervalSeconds = optionChainRuntime.WorkerExecutionPollIntervalSeconds,
    optionChainWorkerExecutionBatchSize = optionChainRuntime.WorkerExecutionBatchSize,
