...
DECLARE @engine_uid uniqueidentifier = 'd26f6038-75a5-5b83-ae76-5f8fc097e903';
DECLARE @engine_code varchar(100) = 'THESIS_PULSE_SMART_MONEY_CONCEPTS';
...
(
    ...
    THROW 611302, 'Smart Money Concepts engine seed drift detected.', 1;
