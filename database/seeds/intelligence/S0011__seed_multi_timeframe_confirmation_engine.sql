...
IF OBJECT_ID(N'[intelligence].[engines]', N'U') IS NULL
    THROW 611101, 'V0004 intelligence.engines is required.', 1;

DECLARE @actor nvarchar(256) = N'ThesisPulse.Seed.S0011';
DECLARE @seed_time datetime2(7) = '2026-06-30T00:00:00';
DECLARE @engine_uid uniqueidentifier = 'b0f95f26-5973-56cb-8b46-30667198f7a1';
DECLARE @engine_code varchar(100) = 'THESIS_PULSE_MULTI_TIMEFRAME_CONFIRMATION';
...
BEGIN
    ...
    (
        @engine_uid,
        @engine_code,
        N'ThesisPulse Multi-Timeframe Confirmation Engine',
        'META_CONTROLLER',
        'ThesisPulse.AI',
        0,
        0,
...
(
    ...
    THROW 611102, 'Multi-timeframe confirmation engine seed drift detected.', 1;
