...
IF OBJECT_ID(N'[intelligence].[engines]', N'U') IS NULL
    THROW 611401, 'V0004 intelligence.engines is required.', 1;

DECLARE @actor nvarchar(256) = N'ThesisPulse.Seed.S0014';
DECLARE @seed_time datetime2(7) = '2026-06-30T00:00:00';
DECLARE @engine_uid uniqueidentifier = 'e3707149-86b6-5c94-bf87-6f90d1a8fa14';
...
BEGIN
    ...
    (
        @engine_uid,
        @engine_code,
        N'ThesisPulse Liquidity and Derivatives Context Engine',
        'DIRECTIONAL_VOTER',
        'ThesisPulse.AI',
        0,
        0,
...
(
    ...
    THROW 611402, 'Liquidity Derivatives engine seed drift detected.', 1;
