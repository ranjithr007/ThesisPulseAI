...
public sealed class DeterministicFusionOptions
{
    ...
    public Dictionary<string, decimal> EngineWeights { get; init; } = new(StringComparer.OrdinalIgnoreCase)
    {
        ["TREND"] = 0.20m,
        ["MOMENTUM"] = 0.15m,
        ["ORDER_FLOW"] = 0.15m,
    ...
    public Dictionary<string, decimal> TimeframeWeights { get; init; } = new(StringComparer.OrdinalIgnoreCase)
    {
        ["1m"] = 0.10m,
        ["5m"] = 0.40m,
        ["15m"] = 0.25m,
