...
IF OBJECT_ID(N'[intelligence].[engines]', N'U') IS NULL
    THROW 611201, 'V0004 intelligence.engines is required.', 1;

DECLARE @actor nvarchar(256) = N'ThesisPulse.Seed.S0012';
DECLARE @seed_time datetime2(7) = '2026-06-30T00:00:00';
DECLARE @engine_uid uniqueidentifier = 'c14e5f27-6494-5a72-9d65-4e7ebf86d8f2';
DECLARE @engine_code varchar(100) = 'THESIS_PULSE_ORDER_FLOW';
...
BEGIN
    ...
    (
        @engine_uid,
        @engine_code,
        N'ThesisPulse Proxy Order Flow Engine',
        'DIRECTIONAL_VOTER',
        'ThesisPulse.AI',
        0,
        0,
...
(
    ...
    THROW 611202, 'Order Flow engine seed drift detected.', 1;
